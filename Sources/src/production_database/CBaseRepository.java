 ...
 * @author Kasimov Ildar
 */
public abstract class CBaseRepository<T extends IBaseDBEntity> 
     ...
     * The main difference that this method throws RuntimeException if
     * there is an entity with the specified name in the database.
     * If you want just to update value of an existing entity 
     * use Update or CreateIfNotExists
     * @param entity A reference to an entity
     */
    public void Create(T entity) {
        if (entity == null) {
            throw new IllegalArgumentException(
        	    "An input argument cannot equal to null");
        }
        ...
        if (existingEntities.size() > 0) {
            throw new RuntimeException(
        	    "The specified entity already exists in the database");
        }
     ...
     * @param entity A reference to an entity
     * @return True if the entity was added into the database, 
    ...
    /**
     * The method updates an entity if it exists. If the specified
     * entity doesn't exist the method throws exception.
     * @param entity A reference to an entity
     */    
    public void Update(T entity) {
        ...
        if (existingEntities.size() < 1) {
            throw new RuntimeException(
        	    "The specified entity doesn't exist in the database");
        }
    ...
    /**
     * The method removes the specified entity if it exists. The method 
     * throws an exception if there is no the specified entity.
     * @param entity
     */    
        ...
        Predicate<T> queryPredicate = new Predicate<T>() {
            public boolean match(T entity) {
                /* compare the name of a current entity with the specified one
                   сравниваем имя текущей сущности с заданным и возвращем её
     ...
     * @return A set of entities of the specified type that are
