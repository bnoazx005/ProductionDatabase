...
public final class CProduct extends CBaseDBEntity implements IProduct {
     ...
     */    
    public CProduct(String name, String code, boolean isStandard,
	            float amountPerYear, String note) {
        super(name);
     ...
     * 
     * It provides to sets up a name and a code of a product. By default 
     * mIsStandard field will set up to false, and mAmountPerYear 
     * will be equal to 0.0f
     * @param name A name of a product
     * @param code A code of a product
     */    
     ...
     * @param amountPerYear amount of a product per year
     */    
    @Override 
