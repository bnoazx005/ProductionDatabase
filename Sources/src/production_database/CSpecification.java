 ...
 * The class implements ISpecification and describes a functionality of 
 * a production specification
 * @author Kasimov Ildar
 */
public final class CSpecification 
	extends CBaseDBEntity implements ISpecification {
     ...
     * @param materials A reference to a map, which contains amounts of 
     * used materials per entity
    ...
    public CSpecification(String name, IProduct product, ICompany manufacturer,
        ...
        if (product == null) {
            throw new IllegalArgumentException(
        	    "The product reference is not initialized");
        }
        
        if (manufacturer == null) {
            throw new IllegalArgumentException(
        	    "The manufacturer reference is not initialized");
        }
        
        if (materials == null) {
            throw new IllegalArgumentException(
        	    "The materials map's reference is not initialized");
        }
     ...
     * @param product A reference to a product
     * @throws IllegalArgumentException The method throws the exception
     * when the parameter equals to null
     */    
    @Override 
     ...
     */        
    @Override 
    public void AddMaterial(IMaterial material, float amount) 
	    throws IllegalArgumentException {
        if (material == null) {
            throw new IllegalArgumentException(
        	    "The material reference is not initialized");
        }
        
        if (mUsedMaterials.containsKey(material)) {
            throw new NoSuchElementException(
        	    "The specification already contains this material");
        }
     ...
     */    
    @Override 
    public void DeleteMaterial(IMaterial material) 
        ...
        if (!mUsedMaterials.containsKey(material)) {
            throw new NoSuchElementException(
        	    "There is no a material with the specified parameters"
...
//      return mUsedMaterials.get(material);
    ...
    /**
     * The method returns a used amount of the material with the specified name
     * if the material is stored in the specification.
     * @param material A reference to a material
     * @return A positive value that describes a used amount of the material
     */
    @Override 
    public float GetMaterialAmount(IMaterial material) 
	    throws NoSuchElementException, IllegalArgumentException {
        if (material == null) {
            throw new IllegalArgumentException(
        	    "The material reference is not initialized");
