...
public interface IBaseRepository<T extends IBaseDBEntity> {
     ...
     * The main difference that this method throws RuntimeException if there
     * is an entity with the specified name in the database.
     * If you want just to update value of an existing entity use Update or
     * CreateIfNotExists
    ...
    /**
     * The method updates an entity if it exists. If the specified entity
     * doesn't exist the method throws exception.
     * @param entity A reference to an entity
     */
