...
public interface ISpecification extends IBaseDBEntity {
     ...
     */
    void AddMaterial(IMaterial material, float amount) 
    ...
    /**
     * The method returns a used amount of the material with the specified
     * name if the material is stored in the specification.
     * @param material A reference to a material
